...
{
    public sealed class SpawnSystem : PixelSystem<BodyComponent, SpawnerComponent>
    {
        public SpawnSystem() : base("Spawn System", threads: 1) { }

        public override void Update(in PixelEntity ntt, ref BodyComponent c1, ref SpawnerComponent c2)
        {
            ...
            //     SpawnManager.Spawn(Db.BaseResources[c2.UnitIdToSpawn], c1.Location, vel);
        }
    }
}