...
namespace MagnumOpus.Simulation.Systems
{
    ...
    public sealed class ReviveSystem : PixelSystem<ReviveComponent, HealthComponent, PositionComponent, StatusEffectComponent>
    {
        public ReviveSystem() : base("Revive System", threads: 1) { }

        public override void Update(in PixelEntity ntt, ref ReviveComponent rev, ref HealthComponent hlt, ref PositionComponent pos, ref StatusEffectComponent eff)
        {
