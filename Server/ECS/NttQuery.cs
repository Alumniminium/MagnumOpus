...
namespace MagnumOpus.ECS
{
    public static class NttQuery
    {
        ...
        {
            private Dictionary<int, NTT>.Enumerator _enumerator = dict.GetEnumerator();
        ...
        [method: MethodImpl(MethodImplOptions.AggressiveInlining)]
        public struct QueryEnumerator<T1, T2>(Dictionary<int, NTT> dict) where T1 : struct where T2 : struct
        {
            private Dictionary<int, NTT>.Enumerator _enumerator = dict.GetEnumerator();
        ...
        [method: MethodImpl(MethodImplOptions.AggressiveInlining)]
        public struct QueryEnumerator<T1, T2, T3>(Dictionary<int, NTT> dict) where T1 : struct where T2 : struct where T3 : struct
        {
            private Dictionary<int, NTT>.Enumerator _enumerator = dict.GetEnumerator();
        ...
        [method: MethodImpl(MethodImplOptions.AggressiveInlining)]
        public struct QueryEnumerator<T1, T2, T3, T4>(Dictionary<int, NTT> dict) where T1 : struct where T2 : struct where T3 : struct where T4 : struct
        {
            private Dictionary<int, NTT>.Enumerator _enumerator = dict.GetEnumerator();
        ...
        [method: MethodImpl(MethodImplOptions.AggressiveInlining)]
        public struct QueryEnumerator<T1, T2, T3, T4, T5>(Dictionary<int, NTT> dict) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct
        {
            private Dictionary<int, NTT>.Enumerator _enumerator = dict.GetEnumerator();
        ...
        [method: MethodImpl(MethodImplOptions.AggressiveInlining)]
        public struct QueryEnumerator<T1, T2, T3, T4, T5, T6>(Dictionary<int, NTT> dict) where T1 : struct where T2 : struct where T3 : struct where T4 : struct where T5 : struct where T6 : struct
        {
            private Dictionary<int, NTT>.Enumerator _enumerator = dict.GetEnumerator();
